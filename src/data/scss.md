...
toc:
  ...
  - text: Specificity & Naming
    link: specificity--naming
  - text: Units
    link: units
  - text: Ordering
    link: ordering
  - text: Linting
    link: linting
description: |
  This document outlines best practices on writing semantic, scalable, and modular CSS. Note that these guidelines assume the use of <a href="http://sass-lang.com/">SASS</a>, a CSS pre-processor, and more specifically, the SCSS syntax. The basis for this guide is to outline distinct rules to format and write SCSS, though the principles outlined here can be applied to CSS or SASS syntax as well.

  This guide borrows concepts from <a href="http://codeguide.co/">Code Guide by @mdo</a>, <a href="https://github.com/necolas/idiomatic-css">Idiomatic CSS</a>, and <a href="http://bem.info/method/">BEM</a>.
---
